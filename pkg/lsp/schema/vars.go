...
func parseVarsArg(src string, argIdx int, parser hclparse.Parser) (map[string]cty.Value, hcl.Diagnostics) {
...
func parseVarsFile(filename string, parser hclparse.Parser) (map[string]cty.Value, hcl.Diagnostics) {
	var f *hcl.File
