...
// DeleteReleaseArtifact provides a mock function with given fields: ctx, r, name
func (_m *MockReleaseProvider_git) DeleteReleaseArtifact(ctx context.Context, r *git.Release, name string) error {
	ret := _m.Called(ctx, r, name)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *git.Release, string) error); ok {
		r0 = rf(ctx, r, name)
	} else {
		r0 = ret.Error(0)
	}
...
//   - r *git.Release
//   - name string
func (_e *MockReleaseProvider_git_Expecter) DeleteReleaseArtifact(ctx interface{}, r interface{}, name interface{}) *MockReleaseProvider_git_DeleteReleaseArtifact_Call {
	return &MockReleaseProvider_git_DeleteReleaseArtifact_Call{Call: _e.mock.On("DeleteReleaseArtifact", ctx, r, name)}
}

func (_c *MockReleaseProvider_git_DeleteReleaseArtifact_Call) Run(run func(ctx context.Context, r *git.Release, name string)) *MockReleaseProvider_git_DeleteReleaseArtifact_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*git.Release), args[2].(string))
	})
	return _c
}
...
func (_c *MockReleaseProvider_git_DeleteReleaseArtifact_Call) RunAndReturn(run func(context.Context, *git.Release, string) error) *MockReleaseProvider_git_DeleteReleaseArtifact_Call {
	_c.Call.Return(run)
	return _c
}

// DownloadReleaseArtifact provides a mock function with given fields: ctx, r, name, filesystem
func (_m *MockReleaseProvider_git) DownloadReleaseArtifact(ctx context.Context, r *git.Release, name string, filesystem afero.Fs) (afero.File, error) {
...
//   - name string
//   - filesystem afero.Fs
func (_e *MockReleaseProvider_git_Expecter) DownloadReleaseArtifact(ctx interface{}, r interface{}, name interface{}, filesystem interface{}) *MockReleaseProvider_git_DownloadReleaseArtifact_Call {
	return &MockReleaseProvider_git_DownloadReleaseArtifact_Call{Call: _e.mock.On("DownloadReleaseArtifact", ctx, r, name, filesystem)}
}

func (_c *MockReleaseProvider_git_DownloadReleaseArtifact_Call) Run(run func(ctx context.Context, r *git.Release, name string, filesystem afero.Fs)) *MockReleaseProvider_git_DownloadReleaseArtifact_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockReleaseProvider_git_DownloadReleaseArtifact_Call) RunAndReturn(run func(context.Context, *git.Release, string, afero.Fs) (afero.File, error)) *MockReleaseProvider_git_DownloadReleaseArtifact_Call {
	_c.Call.Return(run)
	return _c
}
...
// HasReleaseArtifact provides a mock function with given fields: ctx, r, name
func (_m *MockReleaseProvider_git) HasReleaseArtifact(ctx context.Context, r *git.Release, name string) (bool, error) {
	ret := _m.Called(ctx, r, name)

	var r0 bool
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *git.Release, string) (bool, error)); ok {
		return rf(ctx, r, name)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *git.Release, string) bool); ok {
		r0 = rf(ctx, r, name)
	} else {
		r0 = ret.Get(0).(bool)
	}

	if rf, ok := ret.Get(1).(func(context.Context, *git.Release, string) error); ok {
		r1 = rf(ctx, r, name)
	} else {
		r1 = ret.Error(1)
	}
...
//   - r *git.Release
//   - name string
func (_e *MockReleaseProvider_git_Expecter) HasReleaseArtifact(ctx interface{}, r interface{}, name interface{}) *MockReleaseProvider_git_HasReleaseArtifact_Call {
	return &MockReleaseProvider_git_HasReleaseArtifact_Call{Call: _e.mock.On("HasReleaseArtifact", ctx, r, name)}
}

func (_c *MockReleaseProvider_git_HasReleaseArtifact_Call) Run(run func(ctx context.Context, r *git.Release, name string)) *MockReleaseProvider_git_HasReleaseArtifact_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*git.Release), args[2].(string))
	})
	return _c
...
func (_c *MockReleaseProvider_git_HasReleaseArtifact_Call) RunAndReturn(run func(context.Context, *git.Release, string) (bool, error)) *MockReleaseProvider_git_HasReleaseArtifact_Call {
	_c.Call.Return(run)
	return _c
}
...
// TakeReleaseOutOfDraft provides a mock function with given fields: ctx, rel
func (_m *MockReleaseProvider_git) TakeReleaseOutOfDraft(ctx context.Context, rel *git.Release) error {
	ret := _m.Called(ctx, rel)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *git.Release) error); ok {
		r0 = rf(ctx, rel)
	} else {
		r0 = ret.Error(0)
	}
...
//   - ctx context.Context
//   - rel *git.Release
func (_e *MockReleaseProvider_git_Expecter) TakeReleaseOutOfDraft(ctx interface{}, rel interface{}) *MockReleaseProvider_git_TakeReleaseOutOfDraft_Call {
	return &MockReleaseProvider_git_TakeReleaseOutOfDraft_Call{Call: _e.mock.On("TakeReleaseOutOfDraft", ctx, rel)}
}

func (_c *MockReleaseProvider_git_TakeReleaseOutOfDraft_Call) Run(run func(ctx context.Context, rel *git.Release)) *MockReleaseProvider_git_TakeReleaseOutOfDraft_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockReleaseProvider_git_TakeReleaseOutOfDraft_Call) RunAndReturn(run func(context.Context, *git.Release) error) *MockReleaseProvider_git_TakeReleaseOutOfDraft_Call {
	_c.Call.Return(run)
	return _c
}

// UploadReleaseArtifact provides a mock function with given fields: ctx, r, name, file
func (_m *MockReleaseProvider_git) UploadReleaseArtifact(ctx context.Context, r *git.Release, name string, file afero.File) error {
...
//   - name string
//   - file afero.File
func (_e *MockReleaseProvider_git_Expecter) UploadReleaseArtifact(ctx interface{}, r interface{}, name interface{}, file interface{}) *MockReleaseProvider_git_UploadReleaseArtifact_Call {
	return &MockReleaseProvider_git_UploadReleaseArtifact_Call{Call: _e.mock.On("UploadReleaseArtifact", ctx, r, name, file)}
}

func (_c *MockReleaseProvider_git_UploadReleaseArtifact_Call) Run(run func(ctx context.Context, r *git.Release, name string, file afero.File)) *MockReleaseProvider_git_UploadReleaseArtifact_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockReleaseProvider_git_UploadReleaseArtifact_Call) RunAndReturn(run func(context.Context, *git.Release, string, afero.File) error) *MockReleaseProvider_git_UploadReleaseArtifact_Call {
	_c.Call.Return(run)
	return _c
}
